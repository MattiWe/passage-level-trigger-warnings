...
do
    ...
    --training "$DATASETS-$DSI/$SPLIT/multilabel-extended" \
    --validation "$DATASETS-$DSI/$SPLIT/test-multilabel" \
    --test "$DATASETS-$DSI/$SPLIT/test-multilabel" \
